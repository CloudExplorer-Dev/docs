!!! Abstract ""
    ...
    当用户需要新增云主机资源时，无需提前操作任何配置，在【云主机服务】-【云主机】页面，点击【创建】即可选择云账号，创建云主机。
...
!!! Abstract ""
    ...
    用户可通过调整购买数量设置一次创建多台云主机，购买数量为多台时，每台云主机的实例规格相同。若用户想要申请不同实例规格的多台云主机，则需要分多次申请。
    
![阿里基础配置](../../img/cloud-server/create/阿里基础配置.png){ width="1235px" }
![阿里基础配置1](../../img/cloud-server/create/阿里基础配置1.png){ width="1235px" }
...
![阿里网络配置1](../../img/cloud-server/create/阿里网络配置1.png){ width="1235px" }
![阿里网络配置2](../../img/cloud-server/create/阿里网络配置2.png){ width="1235px" }
![阿里网络配置3](../../img/cloud-server/create/阿里网络配置3.png){ width="1235px" }
...
![华为基础配置1](../../img/cloud-server/create/华为基础配置1.png){ width="1235px" }
...
![华为网络配置2](../../img/cloud-server/create/阿里网络配置2.png){ width="1235px" }
![华为网络配置3](../../img/cloud-server/create/阿里网络配置3.png){ width="1235px" }
...
![腾讯基础配置1](../../img/cloud-server/create/腾讯基础配置1.png){ width="1235px" }
...
![腾讯网络配置2](../../img/cloud-server/create/阿里网络配置2.png){ width="1235px" }
![腾讯网络配置3](../../img/cloud-server/create/阿里网络配置3.png){ width="1235px" }
