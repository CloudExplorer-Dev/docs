...
!!! Abstract ""
    ...
    仅支持对包年包月的云主机进行续期操作。<br />
    云主机续期有两种操作方式：<br />
    -方式一：云主机列表的【操作】-【更多】-【续期】，对单台云主机进行续期，支持设置自动续期。<br />
    -方式二：云主机列表上方【更多操作】-【续期】，可选中多台云主机进行批量续期，不支持自动续期。<br />

![续期操作](../../img/cloud-server/server/续期操作.png){ width="1235px" }
![续期操作页面详情](../../img/cloud-server/server/续期操作页面详情.png){ width="1235px" }